...
__export(dist_exports, {
  ...
  download: () => import_chunk_S7CCOJI4.download,
  engineEnvVarMap: () => import_chunk_PXQVM7NP.engineEnvVarMap,
  getBinaryEnvVarPath: () => import_chunk_PXQVM7NP.getBinaryEnvVarPath,
  getBinaryName: () => import_chunk_S7CCOJI4.getBinaryName,
  getCacheDir: () => import_chunk_G7EM4XDM.getCacheDir,
  getProxyAgent: () => import_chunk_OFSFRIEP.getProxyAgent,
  getVersion: () => import_chunk_S7CCOJI4.getVersion,
  maybeCopyToTmp: () => import_chunk_S7CCOJI4.maybeCopyToTmp,
  overwriteFile: () => import_chunk_G7EM4XDM.overwriteFile,
  plusX: () => import_chunk_S7CCOJI4.plusX,
  vercelPkgPathRegex: () => import_chunk_S7CCOJI4.vercelPkgPathRegex
});
module.exports = __toCommonJS(dist_exports);
var import_chunk_S7CCOJI4 = require("./chunk-S7CCOJI4.js");
